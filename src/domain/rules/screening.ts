...
/** FIRST Youth Protection screening and Mentor Ready are renewed each season. */
export const YPP_VALID_YEARS = 1;
  ...
  return [
    {
      ...
      years: YPP_VALID_YEARS,
    },
    {
      item: "Mentor Ready",
      completedOn: p.mentor_ready_on,
      years: YPP_VALID_YEARS,
    },
    {
...
/**
 * The unit the two-adult rule counts (§4.2). Deliberately strict: an adult with
 * no screening on file does not count, whatever their role. If the MPS
 * administrator's screening is held by the district, record those dates on
 * their roster row as attested — do not weaken this predicate.
 */
...
/** Screening that lapses within `days` — surfaced before it bites. */
